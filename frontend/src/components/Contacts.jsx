...
function Contacts({ contacts,changeChat}) {
  const {currentUsername,currentUserImage}=useContext(AuthContext)
        ...
        <Container>
          ...
          <div className="contacts">
            {contacts.map((contact, index) => {
              return (
                <div className={`contact ${index === currentSelectedChat ? "selected" : ""}`} key={index} onClick={()=>{currentChat(index,contact)}}>
